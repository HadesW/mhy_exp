...
namespace ntdll
{
	typedef enum _SYSTEM_INFORMATION_CLASS_T
	{
	...
	} RTL_PROCESS_MODULE_INFORMATION_T, * PRTL_PROCESS_MODULE_INFORMATION_T;

	typedef struct _RTL_PROCESS_MODULES_T
	{
		ULONG NumberOfModules;
		RTL_PROCESS_MODULE_INFORMATION_T Modules[1];
	} RTL_PROCESS_MODULES_T, * PRTL_PROCESS_MODULES_T;
